...
PARTIES = [
    ...
    Record(reading="がいけいきょく", word="外形局", category=Category.LOCATION),
    Record(reading="くういきじゅんけいきょく", word="空域巡警局", category=Category.LOCATION),
    Record(reading="くうじゅんきょく", word="空巡局", category=Category.LOCATION),
...
ITEMS = [
    ...
    Record(reading="うつろがるじゅうぐ", word="虚狩る戎具", category=Category.NOUN),
...
CHARACTERS = [
    ...
    Record(reading="しゃくえん", word="釈淵", category=Category.NAME),
    Record(reading="しゅえん", word="朱鳶", category=Category.NAME),
    Record(reading="しゅんこう", word="瞬光", category=Category.NAME),
...
LOCATIONS = [
    ...
    Record(reading="さんすうきょく", word="算枢局", category=Category.LOCATION),
...
OTHERS = [
    ...
    Record(reading="えいぎょ", word="鋭御", category=Category.NOUN),
    ...
    Record(reading="けっしか", word="結使化", category=Category.NOUN),
    ...
    Record(reading="ごうかく", word="業核", category=Category.NOUN),
    ...
    Record(reading="ぼうしょう", word="暴傷", category=Category.NOUN),
